public class MergeSortDemo {
    ...
    public static void mergeSort(int[]arr){
        ...
        //anropar på oss själva så att den kan fortsätta dela upp vänster och höger
        //tills det endast finns ett tal kvar
        mergeSort(left);
        mergeSort(right);
    ...
    public static void  merge(int[] arr, int[]left, int[]right){
        ...
        //Om det finns vörden kvar i vänstra delen - flytta dessa

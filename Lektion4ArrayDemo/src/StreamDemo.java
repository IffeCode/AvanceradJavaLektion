...
public class StreamDemo {
    ...
    public static void Demo(){
        ...
        List<Integer> sortedAge = persons.stream().filter(p -> p.getSex() != Sex.Male)
                .map( p -> p.getAge())
                .sorted()
                .toList();

...
public class HashMapDemo {
    ...
    public static void Demo(){
        ...
        System.out.println("The capital of Sweden is " +  capitalMap.get("Sweden"));

        System.out.printf("The population in Sweden and Denmark is %d\n", populationMap.get("Sweden")
        + populationMap.get("Denmark"));
